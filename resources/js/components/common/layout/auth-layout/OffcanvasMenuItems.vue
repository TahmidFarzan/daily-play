...
const routeMap = {
    ...
    GameMangement: ["/back-office/game-difficulties/*"],
};
...
<template>
    <div class="flex flex-col space-y-1 text-sm">
        ...
        <a
            ...
            class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100"
            :class="
                isCurrentPage('/back-office/medias/*')
                    ? 'bg-gray-200 font-medium'
                    : ''
            "
        >
        ...
        <button
            @click="toggleShowSubMenu('GameManagement')"
            class="flex items-center justify-between w-full px-3 py-2 rounded hover:bg-gray-100"
        >
            <span class="flex items-center gap-2">
            ...
            <FontAwesomeIcon
                :icon="
                    isSubMenuVisible('GameManagement')
                        ? 'chevron-up'
                        : 'chevron-down'
                "
            />
        ...
        >
            <div
                ...
                class="ml-4 flex flex-col space-y-1 overflow-hidden"
            >
                <a v-if="canAccessGameDifficultyComputed"
                    :href="route('back-office.game-difficulties.index')"
                    class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100"
                    :class="
                        isCurrentPage('/back-office/game-difficulties/*')
                            ? 'bg-gray-200 font-medium'
                            : ''
                    "
                >
