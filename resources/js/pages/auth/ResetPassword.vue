                ...
                <div class="form-group">
                    ...
                    <div class="form-input-wrapper">
                        <input
                            ...
                            :class="{ 'form-input-error': resetPasswordForm.errors.password }"
                        />
                    ...
                    <p v-if="resetPasswordForm.errors.password" class="form-error">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-wrapper">
                        <input
                            ...
                            class="form-input form-input-password"
                            :class="{ 'form-input-error': resetPasswordForm.errors.password_confirmation }"
                        />
                    ...
                    <p v-if="resetPasswordForm.errors.password_confirmation" class="form-error">
